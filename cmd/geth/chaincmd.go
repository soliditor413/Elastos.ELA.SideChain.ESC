...
import (
	...
	"github.com/elastos/Elastos.ELA.SideChain.ESC/internal/era"
	"github.com/elastos/Elastos.ELA.SideChain.ESC/internal/era/eradl"
...
func initGenesis(ctx *cli.Context) error {
	...
	fmt.Println("genesis. extradata ", genesis.ExtraData, "length ", len(genesis.ExtraData))
	return nil
}
