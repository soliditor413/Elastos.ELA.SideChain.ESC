// Copyright 2015 The Elastos ELA Side Chain ESC Authors
...
// ElastosELABootnodes are the enode URLs of the P2P bootstrap nodes running on the
// Elastos ELA Side Chain network.
var ElastosELABootnodes = []string{
	// Elastos ELA Side Chain bootstrap nodes
	// TODO: Add actual Elastos ELA Side Chain bootstrap nodes here
}
