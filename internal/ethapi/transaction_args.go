...
type TransactionArgs struct {
	...
	// Issue detail: https://github.com/elastos/Elastos.ELA.SideChain.ESC/issues/15628
...
func (args *TransactionArgs) setFeeDefaults(ctx context.Context, b Backend, head *types.Header) error {
	...
	// other tx values. See https://github.com/elastos/Elastos.ELA.SideChain.ESC/pull/23274
