...
import (
	...
	"github.com/elastos/Elastos.ELA.SideChain.ESC/crypto/signify"
	"github.com/elastos/Elastos.ELA.SideChain.ESC/internal/build"
	"github.com/elastos/Elastos.ELA.SideChain.ESC/internal/download"
...
var (
	...
	// Files that end up in the esc*.zip archive.
	escArchiveFiles = []string{
		"COPYING",
		executablePath("esc"),
	}

	// Files that end up in the esc-alltools*.zip archive.
	...
	debExecutables = []debExecutable{
		...
		{
			BinaryName:  "esc",
			Description: "Elastos ELA Side Chain CLI client.",
		},
		{
			BinaryName:  "rlpdump",
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/elastos/Elastos.ELA.SideChain.ESC/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/elastos/Elastos.ELA.SideChain.ESC/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/elastos/Elastos.ELA.SideChain.ESC/core/rawdb", "github.com/elastos/Elastos.ELA.SideChain.ESC/ethdb/leveldb"},
		{"github.com/elastos/Elastos.ELA.SideChain.ESC/core/rawdb", "github.com/elastos/Elastos.ELA.SideChain.ESC/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
...
func doArchive(cmdline []string) {
	...
	var (
		...
		geth     = "esc-" + basegeth + ext
		alltools = "esc-alltools-" + basegeth + ext
	)
	maybeSkipArchive(env)
	if err := build.WriteArchive(geth, escArchiveFiles); err != nil {
		log.Fatal(err)
	}
